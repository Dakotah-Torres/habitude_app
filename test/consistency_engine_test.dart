...
void main() {
  group('ConsistencyEngine', () {
    ...
    test('evaluationWindowSize caps at windowWeeks', () {
      ...
      final size = evaluationWindowSize(
        t1,
        completions,
        monday,
        windowWeeks: 6,
    ...
    test(
      'A week with 5 completions against quota 3 counts as 1 hit and 2 extra credit',
      () {
        final completions = [
          TaskCompletion(
            id: '1',
    ...
    test(
      'Canonical 6-week unlock scenario: 6/6 hit quota, 2 total EC -> ratio = 133.3%',
      () {
        final completions = <TaskCompletion>[];
